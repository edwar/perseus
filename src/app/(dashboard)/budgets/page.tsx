  ...
  if (isLoading) {
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between mt-10 md:hidden"><h1 className="text-2xl font-bold">Presupuestos</h1><div className="h-9 w-24 animate-shimmer rounded-lg bg-muted" /></div>
