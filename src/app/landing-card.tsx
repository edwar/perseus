export function LandingCard({ title, desc, gradient }: { title: string; desc: string; gradient: string }) {
  return (
    <div className="rounded-xl border-0 bg-white/70 p-5 shadow-lg shadow-blue-900/5 ring-1 ring-neutral-200/60 backdrop-blur-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl">
